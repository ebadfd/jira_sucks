...
// https://github.com/jcstorino/jira-cli/blob/f06e9d34dcc14e047b30c0fa2ac07ac7d990c12e/pkg/md/jirawiki/parser.go
package jirawiki
...
func (t *Token) handleReferenceLink(line string, out *strings.Builder) int {
	...
	var href, displayText string

	if len(pieces) >= 2 {
		href = pieces[0]
		displayText = pieces[1]
	} else if len(pieces) == 1 {
		href = pieces[0]
		displayText = href
	}

	link := fmt.Sprintf(`<a href="%s">%s</a>`, href, displayText)
